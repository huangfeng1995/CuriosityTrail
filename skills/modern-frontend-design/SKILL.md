...
via `--ease-*`. All durations via `--dur-*`. For light-mode, fintech, wellness palettes → `references/design-systems.md`.
...
@keytml:es tied to view() or scroll() timeline
```
...
Earthly OKLCH palette — clay, sage, warm beige
...
**Source:** [deveshpunjabi/modern-frontend-skill](https://github.com/deveshpunjabi/modern-frontend-skill)
