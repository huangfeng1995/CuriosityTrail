...
- `lazy-loading` - Lazy load non-critical components via dynamic import
- `bundle-splitting` - Split code by route/feature
- `virtualize-lists` - Virtualize lists with 50+ items
- `content-jumping` - Reserve space for async content
- `progressive-loading` - Use skeleton screens instead of spinners
...
- `motion-meaning` - Every animation must express cause-effect relationship
...
- `stagger-sequence` - Stagger entrance by 30–50ms per item
